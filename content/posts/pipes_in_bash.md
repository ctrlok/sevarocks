...
date = "2024-05-12"
updated = "2025-10-18"
description = "Баш — це не стрьом. Іменовані пайпи, синхронізація незалежних процесів і конкурентність на прикладі скрипта паралельного білда та пушу імеджів."
[extra]
og_image = "https://static.seva.rocks/images/bash/pyr.jpg"
+++
...
[^1 left]: Це пояснює деякі античні знахідки:
    ...
    ![/images/bash/pyr.jpg](https://static.seva.rocks/images/bash/pyr.jpg)
...
{% folded(title="Код на go. Cтворений для ілюстрації") %}
